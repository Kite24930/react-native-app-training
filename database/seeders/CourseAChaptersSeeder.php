        ...
        return [
            ...
            [
                ...
                'content' => [
                    ...
                    ['type' => 'list', 'items' => ['<div> → <View> : コンテナ要素', '<p>, <span> → <Text> : テキスト表示（すべての文字列はTextで囲む必要あり）', '<img> → <Image> : 画像表示', '<button> → <TouchableOpacity> or <Pressable> : タッチ操作', '<input> → <TextInput> : テキスト入力', 'HTMLのスクロール可能要素 → <ScrollView> or <FlatList> : スクロール']],
                    ...
                    ['type' => 'heading', 'level' => 2, 'text' => 'StyleSheet によるスタイリング'],
